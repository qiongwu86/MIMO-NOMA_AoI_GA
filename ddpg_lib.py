...
class ActorNetwork(object):
    ...
    def create_actor_network(self):
        inputs = tflearn.input_data(shape=[None, self.s_dim], name="input_")
        ...
        scaled_out = tf.multiply(out, self.action_bound, name="output_")
...
class ActorNetworkLD(object):
    ...
    def __init__(self, sess):
        ...
        self.inputs = graph.get_tensor_by_name("input_"+"/X:0")
        self.scaled_out = graph.get_tensor_by_name("output_"+":0")
...
class DeepQNetwork(object):
    ...
    def create_deep_q_network(self):
        ...
        # Weights are init to Uniform[-3e-3, 3e-3]
        # w_init = tflearn.initializations.uniform(minval=-0.003, maxval=0.003)
        q_out = tflearn.fully_connected(net, self.a_dim, name="output_")
        return inputs, q_out
